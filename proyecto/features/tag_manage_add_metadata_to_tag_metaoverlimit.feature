Feature: Add metadata to an existing tag
  ...
  @user1 @web
  Scenario: As a user I add metadata to a tag with metadata title over limit and got an error
    ...
    Then I enter "<metaover>" into input field having xpath "(//input[@id='meta-title'])[1]"
    When I click on element having css selector ".gh-btn.gh-btn-blue"
    Then I wait for 2 seconds
    Then I should see text "Meta Title cannot be longer than 300 characters"
