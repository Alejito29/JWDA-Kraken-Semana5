Feature: Add metadata to an existing tag
  ...
  @user1 @web
  Scenario: As a user I add metadata to a tag with metadata title on limit
    ...
    Then I enter "<metalimit>" into input field having xpath "(//input[@id='meta-title'])[1]"
    When I click on element having css selector ".gh-btn.gh-btn-blue"
    Then I wait for 2 seconds
    Then I should see text "<metalimit>"
