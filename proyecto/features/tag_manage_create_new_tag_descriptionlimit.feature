Feature: Create a new tag
  ...
  @user1 @web
  Scenario: As a user I create a new tag on on tag manage menu with description on limit
    ...
    Then I enter "<tagdeslimit>" into input field having css selector ".gh-tag-details-textarea"
    When I click on element having css selector ".gh-btn.gh-btn-blue"
    Then I wait for 2 seconds
    Then I should see text "<tagnormal>"
