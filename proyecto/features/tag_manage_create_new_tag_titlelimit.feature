Feature: Create a new tag
  ...
  @user1 @web
  Scenario: As a user I create a new tag on on tag manage menu with title on limit
    ...
    Then I enter "<taglimit>" into input field having xpath "(//input[@id='tag-name'])[1]"
    ...
    Then I should see text "<taglimit>"
